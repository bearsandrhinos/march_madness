view: ncaa_tourney_detailed_results {
  sql_table_name: march_madness.ncaa_tourney_detailed_results ;;
  ...
  dimension: lfga {
    description: "The number of field goal attempts for the losing team"
    type: number
    sql: ${TABLE}.LFGA ;;
  }

  dimension: lfga3 {
    description: "The number of three point field goal attempts for the losing team"
    type: number
    sql: ${TABLE}.LFGA3 ;;
  }
  ...
  dimension: wast {
    description: "The number of assists for the winning team"
    type: number
    sql: ${TABLE}.WAst ;;
  }

  dimension: wblk {
    description: "The number of blocks for the winning team"
    type: number
    sql: ${TABLE}.WBlk ;;
  }

  dimension: wdr {
    description: "The number of defensive rebounds for the winning team"
    type: number
    sql: ${TABLE}.WDR ;;
  }

  dimension: wfga {
    description: "The number of field goal attempts for the winning team"
    type: number
    sql: ${TABLE}.WFGA ;;
  }

  dimension: wfga3 {
    description: "The number of three point field goal attempts for the winning team"
    type: number
    sql: ${TABLE}.WFGA3 ;;
  }

  dimension: wfgm {
    description: "The number of field goals made for the winning team"
    type: number
    sql: ${TABLE}.WFGM ;;
  }

  dimension: wfgm3 {
    description: "The number of three point field goals made for the winning team"
    type: number
    sql: ${TABLE}.WFGM3 ;;
  }
